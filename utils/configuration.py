...
class Configuration:
    def __init__(self, parameter):
        ...
        self.x_steps = {
            f"x{i}": x
            for x, i in zip(parameter["base"]["init_x"], range(self.init_len))
        }
        self.y_steps = {
            f"y{i}": y
            for y, i in zip(parameter["base"]["init_y"], range(self.init_len))
        }
        ...
        self.filter_conv_box_pts = parameter["filter"]["conv_box_pts_val"]

        # set default values for random scattering
        self.rnd_scattering_apply = parameter["randomize_scattering"]["apply"]
        self.rnd_scattering_selected_type = parameter["randomize_scattering"][
            "selected_type"
        ]
        self.rnd_scattering_normal_stadev = parameter["randomize_scattering"][
            "normal_stadev_val"
        ]
        self.rnd_scattering_uniform_range = parameter["randomize_scattering"][
            "uniform_range_val"
        ]
        self.rnd_scattering_weibull_alpha = parameter["randomize_scattering"][
            "weibull_alpha_val"
        ]

        # set default values for randomizing the tightening phase
        self.rnd_tightening_apply = parameter["randomize_tightening"]["apply"]
        self.rnd_tightening_selected_type = parameter["randomize_tightening"][
            "selected_type"
        ]
        self.rnd_tightening_normal_stadev = parameter["randomize_tightening"][
            "normal_stadev_val"
        ]
        self.rnd_tightening_uniform_range = parameter["randomize_tightening"][
            "uniform_range_val"
        ]
        self.rnd_tightening_weibull_alpha = parameter["randomize_tightening"][
            "weibull_alpha_val"
        ]
        self.rnd_tightening_lower_xlimitation = parameter["randomize_tightening"][
            "lower_xlimitation"
        ]
        self.rnd_tightening_upper_xlimitation = parameter["randomize_tightening"][
            "upper_xlimitation"
        ]
        ...
        self.offset_hori_selected_type = parameter["randomize_horizontal_offset"][
            "selected_type"
        ]
        self.offset_hori_normal_stadev = parameter["randomize_horizontal_offset"][
            "normal_stadev_val"
        ]
        self.offset_hori_uniform_range = parameter["randomize_horizontal_offset"][
            "uniform_range_val"
        ]
        self.offset_hori_weibull_alpha = parameter["randomize_horizontal_offset"][
            "weibull_alpha_val"
        ]
        ...
        self.offset_vert_selected_type = parameter["randomize_vertical_offset"][
            "selected_type"
        ]
        self.offset_vert_normal_stadev = parameter["randomize_vertical_offset"][
            "normal_stadev_val"
        ]
        self.offset_vert_uniform_range = parameter["randomize_vertical_offset"][
            "uniform_range_val"
        ]
        self.offset_vert_weibull_alpha = parameter["randomize_vertical_offset"][
            "weibull_alpha_val"
        ]

        # set default values for anomaly (type 1)
        self.anomaly_type_1_generate = parameter["anomalies_type_1"]["generate"]
        self.anomaly_type_1_generate_amount = parameter["anomalies_type_1"][
            "generate_amount_val"
        ]
        self.anomaly_type_1_generate_amount_to_plot = parameter["anomalies_type_1"][
            "generate_amount_to_plot_val"
        ]
        self.anomaly_type_1_lower_xlimitation = parameter["anomalies_type_1"][
            "lower_xlimitation"
        ]
        self.anomaly_type_1_upper_xlimitation = parameter["anomalies_type_1"][
            "upper_xlimitation"
        ]
        self.anomaly_type_1_width = parameter["anomalies_type_1"]["width_val"]
        self.anomaly_type_1_width_selected_type = parameter["anomalies_type_1_width"][
            "selected_type"
        ]
        self.anomaly_type_1_width_normal_stadev = parameter["anomalies_type_1_width"][
            "normal_stadev_val"
        ]
        self.anomaly_type_1_width_uniform_range = parameter["anomalies_type_1_width"][
            "uniform_range_val"
        ]
        self.anomaly_type_1_width_weibull_alpha = parameter["anomalies_type_1_width"][
            "weibull_alpha_val"
        ]
        self.anomaly_type_1_hight = parameter["anomalies_type_1"]["hight_val"]
        self.anomaly_type_1_hight_selected_type = parameter["anomalies_type_1_hight"][
            "selected_type"
        ]
        self.anomaly_type_1_hight_normal_stadev = parameter["anomalies_type_1_hight"][
            "normal_stadev_val"
        ]
        self.anomaly_type_1_hight_uniform_range = parameter["anomalies_type_1_hight"][
            "uniform_range_val"
        ]
        self.anomaly_type_1_hight_weibull_alpha = parameter["anomalies_type_1_hight"][
            "weibull_alpha_val"
        ]
        ...
        self.anomaly_type_2_generate_amount = parameter["anomalies_type_2"][
            "generate_amount_val"
        ]
        ...
        self.anomaly_type_3_generate_amount = parameter["anomalies_type_3"][
            "generate_amount_val"
        ]
        ...
        self.anomaly_type_4_generate_amount = parameter["anomalies_type_4"][
            "generate_amount_val"
        ]
        ...
        self.show_linear_basis_observation = parameter["visualization"][
...
def get_distribution(
    default_parameter: dict, info_text: dict, selection: list, key: int
...
def show_linear_basis(Config: Configuration) -> None:
    ...
    Config.show_linear_basis = bool_to_numeric(
        sidebar.checkbox(
...
def update_config(Config: Configuration) -> None:
    ...
    parameter["randomize_scattering"][
        "selected_type"
    ...
    parameter["randomize_tightening"][
        "selected_type"
    ...
    parameter["randomize_tightening"][
        "lower_xlimitation"
    ] = Config.rnd_tightening_lower_xlimitation
    parameter["randomize_tightening"][
        "upper_xlimitation"
